...
const HoodieMenu = ({items, cartItems}) => {
          ...
          <div className='menu-color-buttons'>
            ...
            <div className='row-flex'>
              <input
                ...
                onChange={() => setSelectedPrice('40')}
              />
              <label htmlFor="40" className="input-text">40+</label>
            </div>
            <div className='row-flex'>
              <input
                type="radio"
              ...
              />
              <label htmlFor="50" className="input-text">50+</label>
            </div>
          </div>
        </div>
